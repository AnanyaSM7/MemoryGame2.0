...
function checkForMatch() {
  ...
  if (emoji1 === "🃏" || emoji2 === "🃏") {
    const nonJoker = emoji1 === "🃏" ? emoji2 : emoji1;
...
function checkLevelComplete() {
  if (matchedCount >= 24) {
    clearInterval(timer);
    isFrozen=true;
      levelClearMessage.textContent = "Yay! You Won! Great game."
...
// 2 seconds delay before swapping message to button
  }
}
...
document.getElementById("next-level-btn").addEventListener("click", () => {
  window.location.href = "level3.html";  // Change this path if your level 2 file has a different name
});
